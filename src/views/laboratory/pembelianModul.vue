<template class="">
    <div class="">
      <topBarResponsive v-if="windowWidth <= 767" @scrollto="goto" class=" fixed top-0 z-40"/>
      ...
      <div v-if="this.login == false" class=" overflow-hidden">
        <div class=" fixed w-screen z-10">
          <iframe src="https://formfacade.com/headless/116405565780253727687/home/form/1FAIpQLSfNsUky9-OmLWLM8MalRytEY9ylg4SLZQdOdK1ciRw5ev5Miw" class=" w-full h-screen overflow-hidden" frameborder="0" marginheight="0" marginwidth="0" style="filter: blur(0.6rem);">Memuat…</iframe>
        </div>
        ...
        <div class=" z-30 w-screen h-screen fixed flex items-center justify-center">
          <div class=" bg-yellow-300 p-5 rounded-lg md:w-auto w-3/4"> 
            <div class=" md:text-xl text-base md:font-semibold">Kamu memerlukan akses untuk mendaftar :( </div>
      ...
      <div v-else>
        <iframe src="https://formfacade.com/headless/116405565780253727687/home/form/1FAIpQLSfNsUky9-OmLWLM8MalRytEY9ylg4SLZQdOdK1ciRw5ev5Miw" class=" w-full h-screen pt-16 overflow-hidden" frameborder="0" marginheight="0" marginwidth="0">Memuat…</iframe>
      </div>
