<template>
  ...
  <div v-if="this.login == false" class=" overflow-hidden">
    ...
    <div v-else class=" h-full">
      <iframe src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQzlE-1aIACtQEcWmeHoSfvdICaXPUAdmCmfiZ-hfdPli1PiztB06rIiOp5up6BOupwfXVpHFyRnUqv/pubhtml?gid=974194652&amp;single=true&amp;widget=true&amp;headers=false" class=" w-full flex items-center h-screen justify-center pt-16"></iframe>
